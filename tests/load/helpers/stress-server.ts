...
/**
 * Wire up all services without the Fastify HTTP layer.
 * Direct service access for stress testing — no HTTP overhead.
 */
export function createStressServer(pool: pg.Pool): StressServer {
